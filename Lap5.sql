...
-- Write a query to get any employee who is from department ‘Executive’
...
-- Write a query to get all employee who is working on department 50, 70, 90
...
-- Retrieve the average of the Commissions of the employees.
...
-- Write a query to retrieve departments' names and cities for all departments that has 
...
-- Write a query to get any employee who has salary greater than or equal to 10000
select e.EMPLOYEE_ID, e.FIRST_NAME, e.LAST_NAME, e.SALARY
from employees e
where e.SALARY >= 10000;

-- Write a query to find employee who has salary from 5K to 10K
...
-- Retrieve all employees who are hired on 7/6/2002.
